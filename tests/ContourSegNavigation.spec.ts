...
test('should navigate the contours when clicking each segments in the right panel', async ({
  ...
  await expect(getSegment(3).selectedIndicator).toBeVisible();
  ...
  await expect(getSegment(2).selectedIndicator).toBeVisible();
  ...
  await expect(getSegment(1).selectedIndicator).toBeVisible();
  ...
  await expect(getSegment(0).selectedIndicator).toBeVisible();
