...
test('should create and download the TMTV CSV report correctly', async ({ page }) => {
  ...
  expect(
    ...
    /^id,label,min,max,mean,stdDev,median,skewness,kurtosis,count,maxLPS,minLPS,center,volume,lesionGlycolysis,peakValue,peakLPS,PatientID,PatientName,StudyInstanceUID,SeriesInstanceUID,StudyDate/
  );
