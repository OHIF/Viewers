...
const Calibration = {
  ...
  toMeasurement: (
    ...
    console.log('***** Calibration.toMeasurement');
    const { annotation, viewportId } = csToolsEventDetail;
    const { metadata, data, annotationUID } = annotation;

    if (!metadata || !data) {
      console.warn('Calibration tool: Missing metadata or data');
      return null;
    }
...
function _getReport(mappedAnnotations, points, FrameOfReferenceUID) {
  ...
  values.push('Cornerstone:CalibrationLine');
  ...
  console.log('**** CalibrationLine.getReport', mappedAnnotations);
