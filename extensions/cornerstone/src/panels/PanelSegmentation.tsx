...
export default function PanelSegmentation({
  ...
  return (
    ...
    >
      {children}
      <OHIFSegmentationTable.Config />
      <OHIFSegmentationTable.AddSegmentationRow />

      {SegmentationTableMode === 'collapsed' ? (
        <OHIFSegmentationTable.Collapsed>
          <OHIFSegmentationTable.SelectorHeader>
            <CustomDropdownMenuContent />
          </OHIFSegmentationTable.SelectorHeader>
          <OHIFSegmentationTable.AddSegmentRow />
          <OHIFSegmentationTable.Segments />
        </OHIFSegmentationTable.Collapsed>
      ) : (
        <OHIFSegmentationTable.Expanded>
          <OHIFSegmentationTable.Header>
            <CustomDropdownMenuContent />
          </OHIFSegmentationTable.Header>
          {/* <OHIFSegmentationTable.AddSegmentRow /> */}
          <OHIFSegmentationTable.Segments />
