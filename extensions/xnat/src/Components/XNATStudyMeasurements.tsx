...
import XNATStudySummaryWithActions from './XNATStudySummaryWithActions';
...
export function XNATStudyMeasurements(props): React.ReactNode {
  ...
  return (
    ...
    >
      <AccordionGroup.Trigger>
        <XNATStudySummaryWithActions {...props} />
      </AccordionGroup.Trigger>
...
export default XNATStudyMeasurements; 