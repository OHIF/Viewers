...
const XNATColorMapSelect = ({ value, formatOptionLabel, options }) => (
  <Select
    value={value}
    formatOptionLabel={formatOptionLabel}
    styles={XNATColorMapSelectStyles}
    options={options}
  />
);
...
const XNATColorMapSelectStyles = {
...
export default XNATColorMapSelect;
