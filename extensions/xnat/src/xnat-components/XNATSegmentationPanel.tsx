...
import XNATSegmentationExportMenu from './XNATSegmentationExportMenu/XNATSegmentationExportMenu.js';
import XNATSegmentationImportMenu from './XNATSegmentationImportMenu/XNATSegmentationImportMenu.js';
import XNATSegmentationSettings from './XNATSegmentationSettings/XNATSegmentationSettings.js';
import getElementFromFirstImageId from '../utils/getElementFromFirstImageId.js';
...
import { XNAT_EVENTS } from '../utils/index.js';
import SegmentationStatsMenu from './XNATSegmentationMenu/SegmentationStatsMenu.js';
import sessionMap from '../utils/sessionMap.js';

import './XNATRoiPanel.styl';

interface XNATSegmentationPanelProps {
  isOpen?: boolean;
  studies?: string[];
  viewports?: any[];
  activeIndex?: number;
  onJumpToItem: (data: any) => void;
  commandsManager: any;
  servicesManager: any;
...
interface XNATSegmentationPanelState {
  importMetadata: any;
  segments: any[];
  activeSegmentIndex: number;
  importing: boolean;
  exporting: boolean;
  showSegmentationSettings: boolean;
  firstImageId: string;
  labelmap3D: any;
  show2DStats: boolean;
}
...
export default class XNATSegmentationPanel extends React.Component {
  ...
  onMaskClick(segmentIndex, frameIndex) {
    const { activeIndex, onJumpToItem, viewports } = this.props;
