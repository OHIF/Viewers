...
export default defineConfig({
  ...
  webServer: {
    command:
      'cross-env APP_CONFIG=config/e2e.js COVERAGE=true OHIF_PORT=3335 OHIF_OPEN=false nyc pnpm --filter @ohif/app exec rspack serve --config .rspack/rspack.pwa.js',
