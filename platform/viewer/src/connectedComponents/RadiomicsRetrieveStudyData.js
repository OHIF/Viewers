...
import ConnectedViewer from './ConnectedRadiomics';
...
function RadiomicsRetrieveStudyData({
  server,
  studyInstanceUIDs,
  seriesInstanceUIDs,
...
RadiomicsRetrieveStudyData.propTypes = {
...
export default RadiomicsRetrieveStudyData;
