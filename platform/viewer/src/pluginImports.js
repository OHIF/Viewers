...
async function loadModule(module) {
    ...
    if (module === "@ohif/mode-test") {
        const imported = await
        import ("@ohif/mode-test");
        return imported.default;
    }
    if (module === "@ohif/mode-basic-dev-mode") {
        const imported = await
        import ("@ohif/mode-basic-dev-mode");
        return imported.default;
    }
