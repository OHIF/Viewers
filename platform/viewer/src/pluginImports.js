...
async function loadModule(module) {
  ...
  if( module==="extension-lytic-lesion") {
    const imported = await import("extension-lytic-lesion");
    return imported.default;
  }
  ...
  if( module==="lytic-lesions") {
    const imported = await import("lytic-lesions");
    return imported.default;
  }
