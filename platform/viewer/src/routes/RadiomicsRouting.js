...
//
import ConnectedViewerRetrieveStudyData from '../connectedComponents/ConnectedRadiomicsRetrieveStudyData ';
...
function RadiomicsRouting({ match: routeMatch, location: routeLocation }) {
  const {
    project,
    location,
    dataset,
...
export default RadiomicsRouting;
