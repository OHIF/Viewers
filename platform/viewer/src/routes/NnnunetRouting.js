...
import Nnunet from '../pages/Nnunet';
...
function NnnunetRouting({ match: routeMatch, location: routeLocation }) {
  const {
    project,
    location,
    dataset,
  ...
  if (server && studyUIDs) {
    return (
      <Nnunet studyInstanceUIDs={studyUIDs} seriesInstanceUIDs={seriesUIDs} />
    );
  }
