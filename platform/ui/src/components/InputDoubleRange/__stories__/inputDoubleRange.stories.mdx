...
<Meta title="Components/InputDoubleRange" component={InputDoubleRange} />
...
<Heading title="InputDoubleRange" componentRelativePath="InputDoubleRange/InputDoubleRange.tsx" />
