  ...
  {() => {
    ...
    const tableDataSource = studies.map((study, key) => {
      ...
      const seriesTableDataSource = series.map((seriesItem) => {
        const { SeriesNumber, Modality, instances, SeriesDescription } = seriesItem;
        return {
      ...
      seriesTableDataSource[0].Instances = 1;
      seriesTableDataSource[1].Instances = 1;
      seriesTableDataSource[2].Instances = 350;
      seriesTableDataSource[3].Instances = 200;
      seriesTableDataSource[4].Instances = 200;
      seriesTableDataSource[5].Instances = 273;
      return {
        row: [
          {
            key: 'patientName',
