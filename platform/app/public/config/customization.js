...
window.config = {
  ...
  customizationService: {
    // Pulls in platform/app/public/customizations/worklist/descriptionOnly.jsonc,
    // which configures the WorkList study list to show only Description column.
    requires: ['worklist/descriptionOnly'],
