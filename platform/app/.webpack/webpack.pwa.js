...
module.exports = (env, argv) => {
  ...
  const mergedConfig = merge(baseConfig, {
    ...
    resolve: {
      alias: {
        'measurement-tracking': path.resolve(
          __dirname,
          '../../../extensions/ohif-measurement-tracking/src'
        ),
        'cornerstone-dicom-seg': path.resolve(
          __dirname,
          '../../../extensions/ohif-cornerstone-dicom-seg/src'
        ),
        'cornerstone-dicom-rt': path.resolve(
          __dirname,
          '../../../extensions/ohif-cornerstone-dicom-rt/src'
        ),
        'cornerstone-dicom-sr': path.resolve(
          __dirname,
          '../../../extensions/ohif-cornerstone-dicom-sr/src'
        ),
      ...
      modules: [
        ...
        path.resolve(__dirname, '../../../extensions/extension2/node_modules'),
        path.resolve(__dirname, '../../../modes/mode2/node_modules'),
        path.resolve(__dirname, '../../../extensions/ohif-measurement-tracking/node_modules'),
        path.resolve(__dirname, '../../../extensions/ohif-cornerstone-dicom-seg/node_modules'),
        path.resolve(__dirname, '../../../extensions/ohif-cornerstone-dicom-rt/node_modules'),
        path.resolve(__dirname, '../../../modes/rtmode/node_modules'),
        path.resolve(__dirname, '../../../modes/segmentation/node_modules'),
      ],
    },
