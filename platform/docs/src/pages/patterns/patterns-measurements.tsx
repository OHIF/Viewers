            ...
            <div className="w-64 space-y-0">
              ...
              >
                ...
                <AccordionItem value="measurements-list">
                  <AccordionTrigger className="bg-popover hover:bg-primary-light text-muted-foreground my-0.5 flex h-7 w-full items-center justify-between rounded py-2 pr-1 pl-2 font-normal">
                ...
                <AccordionItem value="measurements-additional">
                  ...
                  <AccordionContent>
                    <div className="bg-primary-main mb-0.5 h-12 rounded-b pb-3"></div>
                  </AccordionContent>
                </AccordionItem>
              </Accordion>
            </div>
