    ...
    <div className="my-4 flex max-w-6xl justify-end py-6">
      <div className="w-64 space-y-0">
        ...
        <PanelSection title="Segmentation Tools">
          <div className="bg-primary-dark mb-0.5 h-32 rounded-b pb-3"></div>
        </PanelSection>
        ...
        <PanelSection title="Segmentation List">
          <div className="mb-0">
            ...
            <div className="bg-primary-dark flex h-10 w-full items-center space-x-1 rounded-t px-1.5">
              <DropdownMenu>
                ...
                <DropdownMenuContent align="start">
                  ...
                  <DropdownMenuItem>
                    <Icons.Rename className="text-foreground" />
                    <span className="pl-2">Renamess</span>
                  </DropdownMenuItem>
                  <DropdownMenuItem>
                    <Icons.Delete className="text-foreground" />
                    <span className="pl-2">Delete</span>
            ...
            <PanelSection
              ...
              icon="Controls"
              headerClassName="bg-primary-dark hover:bg-accent mt-0.5 flex h-7 w-full items-center justify-between rounded-b pr-1 pl-2 font-normal text-primary"
            >
              <div className="bg-primary-dark mb-0.5 space-y-2 rounded-b px-1.5 pt-0.5 pb-3">
                <div className="mx-1 mb-2.5 mt-1 flex items-center justify-between space-x-4">
                  {/* Display Label with Selected Tab */}
                  <div className="text-muted-foreground text-xs">Show: {selectedTab}</div>
                  {/* Tabs Controls */}
