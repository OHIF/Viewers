...
import { Icons, Tooltip } from '@ohif/ui-next'; // <— updated import
// If you had a direct import { Icon } from 'ui', remove that in favor of the new Icons component.
...
function LegacyPatientInfo({
  ...
  return (
    <div ref={showPatientInfoRef}>
          ...
          isOpen && (
            <div className="flex py-2">
              <div className="flex pt-1">
                {/* Replacing old <Icon> with new Icons component */}
      ...
      >
        {/* Replace the old stacked icons with a single icon or two icons if you prefer */}
