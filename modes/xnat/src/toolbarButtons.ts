...
const toolbarButtons = [
  ...
  },
  {
    ...
    props: {
      ...
      evaluate: {
        name: 'evaluate.cornerstone.segmentation',
        secondaryEvaluator: 'evaluate.displaySetIsReconstructable',
  ...
  },
  {
    ...
    props: {
      ...
      evaluate: {
        ...
        hasSegmentationEvaluator: 'evaluate.cornerstone.hasSegmentation',
      },
      listeners: {
        [ViewportGridService.EVENTS.ACTIVE_VIEWPORT_ID_CHANGED]: callbacks('LabelmapSlicePropagation'),
