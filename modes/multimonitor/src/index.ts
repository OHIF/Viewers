...
const extensionDependencies = {
  ...
  '@ohif/extension-multimonitor': '^3.0.0',
};
...
function modeFactory() {
  return {
    ...
    // We should not be.
    id,
    routeName: 'multimonitor',
    displayName: i18n.t('Modes:Multimonitor'),
    /**
     * Lifecycle hooks
     */
    onModeEnter: ({ servicesManager, extensionManager, commandsManager }) => {
      ...
      commandsManager.runCommand('applyMultiMonitor');
    ...
    hangingProtocol: '@ohif/hpMultiMonitor1',
